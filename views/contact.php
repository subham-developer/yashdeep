...
?>
    ...
    <section class="breadcrumb breadcrumb_bg banner-bg-1 overlay2 ptb200">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 offset-lg-1" data-aos="fade-left" data-aos-easing="linear"
    ...
    <section class="contact-section">
        <div class="container">
            <!-- <div class="d-none d-sm-block mb-5 pb-4" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                ...
                <!-- <div id="map" style="height: 480px; position: relative; overflow: hidden;">
                    <div
                        ...
                        <div class="gm-style"
                            ...
                            <div tabindex="0"
                                style="position:absolute;z-index:0;left:0;top:0;height:100%;width:100%;padding:0;border-width:0;margin:0;cursor:url(https://maps.gstatic.com/mapfiles/openhand_8_8.cur) , default;touch-action:pan-x pan-y">
                                <div
            ...
            <div class="row" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                ...
                <div class="col-lg-8">
                    <form class="form-contact contact_form" action="php/process.php" method="post" id="contactForm" novalidate>
                        <div class="row">
                            <div class="col-12">
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            ...
                            <p>Vasai (E), Palghar - 401 208.</p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                        <div class="media-body">
                            <h3>+91-7304343004 +91-7506306663</h3>
                    ...
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3><a href="https://preview.colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__"
                                    data-cfemail="b0c3c5c0c0dfc2c4f0d3dfdcdfc2dcd9d29ed3dfdd">[email&#160;protected]</a>
                            </h3>
    ...
    <script>
        ...
        //         type: 'POST',
        //         dataType: "JSON",
        //         url: "https://www.zerobroker.in/processor.php?classic=true",
        //         headers: {
        ...
        //         },
        //         data: { message: message, name: name, email: email, subject: subject, utm_source: utm_source, utm_medium: utm_medium },
        //         beforeSend: function () {
        //             // $('#submit').prop('disabled', true);
        //             // getId = $(this).attr("id");
        //             // console.log("Hello");
        //             $('.loader_img_for_audited').css('display', 'inline-block');
        //             // $('.save_draft_btn').hide();
        //             // $('#last_submit').hide();
        //             // $('.loader_img').show();
        ...
        //             $(".partne_frmin").css('display', "none");
        //             $(".partsuc_msg").css('display', "block");

        //             $('.firstPhaseForm').hide();

        //             $('.secondPhaseForm').show();
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"6d4b2b179e9c31d0","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.12.0","si":100}'
        crossorigin="anonymous"></script>
</body>

<!-- Mirrored from preview.colorlib.com/theme/durg/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jan 2022 15:16:01 GMT -->
